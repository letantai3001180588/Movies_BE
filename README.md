...
<img src="https://media.hoclaptrinh.vn/images/django-la-gi-01.png" style="width:100px;margin-right:30px;"/> 
<img src="https://blog.haposoft.com/content/images/2018/08/logo.png" style="width:100px;margin-right:30px;"/>
...
http http://127.0.0.1:8000/api/v1/movies/  
Get a single movie
http GET http://127.0.0.1:8000/api/v1/movies/{movie_id}/  
Create a new movie
http POST http://127.0.0.1:8000/api/v1/movies/  title="Ant Man and The Wasp" genre="Action" year=2018 
Full update a movie
http PUT http://127.0.0.1:8000/api/v1/movies/{movie_id}/  title="AntMan and The Wasp" genre="Action" year=2018
Partial update a movie
http PATCH http://127.0.0.1:8000/api/v1/movies/{movie_id}/  title="AntMan and The Wasp" 
Delete a movie
http DELETE http://127.0.0.1:8000/api/v1/movies/{movie_id}/ 
```

### Pagination
The API supports pagination, by default responses have a page_size=10 but if you want change that you can pass through params page_size={your_page_size_number}
```
http http://127.0.0.1:8000/api/v1/movies/?page=1 
http http://127.0.0.1:8000/api/v1/movies/?page=3 
http http://127.0.0.1:8000/api/v1/movies/?page=3&page_size=15 
```

### Filters
The API supports filtering, you can filter by the attributes of a movie like this
```
http http://127.0.0.1:8000/api/v1/movies/?title="AntMan" 
http http://127.0.0.1:8000/api/v1/movies/?year=2020 
http http://127.0.0.1:8000/api/v1/movies/?year__gt=2019&year__lt=2022 
http http://127.0.0.1:8000/api/v1/movies/?genre="Action" 
http http://127.0.0.1:8000/api/v1/movies/?creator__username="myUsername" 
```

You can also combine multiples filters like so
```
http http://127.0.0.1:8000/api/v1/movies/?title="AntMan"&year=2020 
http http://127.0.0.1:8000/api/v1/movies/?year__gt=2019&year__lt=2022&genre="Action" 
```
